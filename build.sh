...
cp -R  ./includes ./libraries ./admin/js ./admin/assets/dist ./admin/includes ./admin/commercebird-icon.svg ./vendor ./*.php composer.json changelog.txt  LICENSE readme.txt ./"$plugin_name"/ --parents
