...
cp -R  ./includes ./libraries ./admin/js ./admin/assets/dist ./admin/includes ./admin/commercebird-icon.svg ./vendor ./*.php composer.json changelog.txt  LICENSE README.md  ./"$plugin_name"/ --parents
...
sed -i '70,77d' ./"$plugin_name"/plugin.php
sed -i '73,76d' ./"$plugin_name"/admin/includes/Template.php
