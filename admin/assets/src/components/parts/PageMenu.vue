      ...
      <div class="relative flex justify-between h-16">
        ...
        >
          <router-link class="flex items-center flex-shrink-0 gap-2" to="/">
            <Logo/>
            <span class="font-sans text-xl italic font-bold">wooventory</span>
          </router-link>
          <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
            ...
            <router-link
                :class="{
                'border-b-2 border-indigo-500 text-gray-900':
                  useRouter().currentRoute.value.path === '/zoho-inventory',
                'border-b-2 border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700':
                  useRouter().currentRoute.value.path !== '/zoho-inventory',
              }"
            ...
            >
              ...
              <template #content>
                <div class="flow-root">
                  ...
                  />
                  <ul
                      v-if="Object.keys(store.changelog).length > 0"
                      class="-mb-8"
                  >
                    <li v-for="(item, index) in store.changelog" :key="index">
...
import {backendAction, formatDate, useStorage} from "@/composables";
