...
import {ClipboardDocumentCheckIcon, ClipboardDocumentIcon, ExclamationCircleIcon,} from "@heroicons/vue/24/outline";
...
const hints = {
  pluginDoc: {
    ...
    link: "https://support.roadmapstudios.com/portal/en/kb/zoho-inventory-woocommerce",
    linkText: "Visit Here",
  },
  zohoDoc: {
    icon: ExclamationCircleIcon,
